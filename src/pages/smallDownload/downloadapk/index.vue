  ...
  export default {
    data () {
      return {
        ...
        downloadLink: `https://qiniu-app.qtshe.com/v1.5.1-${Number(util.getQueryString('channel') || 0)}-%E8%B5%9A%E9%92%B1%E5%9B%A2.apk`
      }
    },
    mounted() {
      this.downloadLink = `https://qiniu-app.qtshe.com/v1.5.1-${this.channelId}-%E8%B5%9A%E9%92%B1%E5%9B%A2.apk` //链接待替换
      if (this.iswechat()) {
        //微信浏览器出现mask
        this.visible = true
      } else {
